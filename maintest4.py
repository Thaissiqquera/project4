...
# Criar o arquivo HTML dentro do diretório templates
...
async def analyze_data(
    ...
    # Retornar template HTML com resultados
    return templates.TemplateResponse(
        "index.html", 
        {
            ...
            "results": results,
            "show_results": True,
            "cluster_chart": results['cluster_chart'],
            "campaign_chart1": results['campaign_chart1'],
            "campaign_chart2": results['campaign_chart2'],
            "regression_chart": results['regression_chart'],
            "clv_chart": results['clv_chart'],
            "cluster_info": results['cluster_info'],
            "regression_info": results['regression_info'],
            "high_value_clients": results['high_value_clients'],
